        ...
        <td>'.$value["fecha_actualizacion"].'</td>';
          ...
          <div class="btn-group">
           ...
           <i class="fa fa-pencil"></i></button>
            <button class="btn btn-danger btnEliminarUsuario" idUsuario="'.$value["id"].'">
            ...
            <!-- ENTRADA PARA EL CORREO-->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                placeholder="Ingresar Correo Electronico" id="nuevoEmail" required>
  ...
  <div class="modal-dialog">
    ...
    <!-- CABEZA DEL MODAL -->
      ...
      <div class="modal-header" style="background:#3c8dbc; color:white">
        ...
        <h4 class="modal-title">Editar Usuario del Sistema</h4>
            ...
            <!-- ENTRADA PARA EL CORREO-->
             ...
             <div class="form-group">
              ...
              <div class="input-group">
                ...
                <input type="text" class="form-control input-lg" name="editarEmail" value=" " id="editarEmail" readonly>
