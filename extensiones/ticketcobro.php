...
$cobroData = ControladorExceso::ctrMostrarExceso('idcobro', $idCobro);
...
if ($cobroData) {
    ...
    $pdf = new FPDF('P', 'mm', [80, 100]); // Ticket tamaño 80mm x 297mm
    $pdf->AddPage();
...
// Ajustar los márgenes y la alineación del texto
    ...
    AddText($pdf, 'SERVICIO POR EXCESO', 5, 15, 'C', 'Arial', 'B', 10, 0, 0, 0);
    
    // Número del Cobro
    $pdf->SetFont('Arial', 'B', 9);
    $pdf->SetXY(5, 25);
    $pdf->Cell(25, 5, "No. Exceso:", 0, 0, 'L');
    $pdf->SetFont('Arial', '', 9);
    $pdf->Cell(50, 5, $cobro['idcobro'], 0, 1, 'L');
    ...
    $pdf->SetFont('Arial', 'B', 9);
    $pdf->SetXY(5, 35);
    $pdf->Cell(40, 5, "Exceso menor:", 0, 0, 'L');
    $pdf->SetFont('Arial', '', 9);
    $pdf->Cell(20, 5, utf8_decode($cobro['exceso_menor'] . " m³"), 0, 1, 'L');

    $pdf->SetFont('Arial', 'B', 9);
    $pdf->SetXY(5, 40);
    $pdf->Cell(40, 5, "Exceso mayor:", 0, 0, 'L');
    $pdf->SetFont('Arial', '', 9);
    $pdf->Cell(20, 5, utf8_decode($cobro['exceso_mayor'] . " m³"), 0, 1, 'L');
    ...
    $pdf->SetFont('Arial', '', 9);
    $pdf->Cell(50, 5, "Q " . number_format($cobro['total_a_pagar'], 2), 0, 1, 'L');
    
    // Estado del cobro
    $pdf->SetFont('Arial', 'B', 9);
    $pdf->SetXY(5, 50);
    $pdf->Cell(25, 5, "Estado:", 0, 0, 'L');
    $pdf->SetFont('Arial', '', 9);
    ...
    $pdf->SetFont('Arial', 'B', 9);
    $pdf->SetXY(5, 55);
    $pdf->Cell(25, 5, "Fecha cobro:", 0, 0, 'L');
    $pdf->SetFont('Arial', '', 9);
